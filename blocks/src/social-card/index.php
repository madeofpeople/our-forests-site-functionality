...
function services( $service, $attributes ) {
	...
	$services_data = array(
		'facebook'  => array(
			...
			'url'   => \esc_url( 'https://www.facebook.com/sharer/sharer.php?u=' . $permalink . '&title=' . $title_encoded ),
		...
		'instagram' => array(
			...
			'url'   => isset( $attributes['instagram'] ) ? \esc_url( $attributes['instagram'] ) : '',
			'icon'  => '<svg width="24" height="24" viewBox="0 0 24 24" version="1.1">
		...
		'mail'      => array(
			...
			'url'   => \esc_url( 'mailto:?subject=' . $title_encoded . '&body=' . $message_encoded . $separator . $permalink ),
			'icon'  => '<svg width="24" height="24" viewBox="0 0 24 24" version="1.1">
		...
		'sms'       => array(
			...
			'url'   => \esc_url( 'sms:?&body=' . $title_encoded . ' - ' . $permalink ),
