 ...
 */
namespace Site_Functionality\Blocks\SocialCard;
...
/**
 * Registers the `site-functionality/social-card` block on the server.
 */
function register() {
	\register_block_type(
		__DIR__,
...
function services( $service, $attributes ) {
	...
	$services_data = array(
		'facebook'  => array(
			...
			'url'   => \esc_url( 'https://www.facebook.com/sharer/sharer.php?u=' . $permalink . '&title=' . $post_title_encoded ),
		...
		'flipboard' => array(
			...
			'url'   => \esc_url( 'https://share.flipboard.com/bookmarklet/popout?url=' . $permalink . '&title=' . $message_encoded ),
		...
		'line'      => array(
			...
			'url'   => \esc_url( 'https://lineit.line.me/share/ui?url=' . $permalink . '&text=' . $message_encoded ),
		...
		'linkedin'  => array(
			...
			'url'   => \esc_url( 'https://www.linkedin.com/shareArticle?mini=true&url=' . $permalink . '&title=' . $message_encoded ),
		...
		'mail'      => array(
			...
			'url'   => \esc_url( 'mailto:?subject=' . $post_title_encoded . '&body=' . $message_encoded . $separator . $permalink ),
		...
		'print'     => array(
			...
			'url'   => \esc_js( 'javascript:window.print()' ),
		...
		'reddit'    => array(
			...
			'url'   => \esc_url( 'https://www.reddit.com/submit?url=' . $permalink . '&title=' . $message_encoded ),
		...
		'skype'     => array(
			...
			'url'   => \esc_url( 'https://web.skype.com/share?url=' . $permalink ),
		...
		'sms'       => array(
			...
			'url'   => \esc_url( 'sms:?&body=' . $post_title_encoded . ' - ' . $permalink ),
		...
		'telegram'  => array(
			...
			'url'   => \esc_url( 'https://telegram.me/share/url?url=' . $permalink . '&text=' . $message_encoded ),
		...
		'tumblr'    => array(
			...
			'url'   => \esc_url( 'https://tumblr.com/widgets/share/tool?canonicalUrl=' . $permalink . '&title=' . $message_encoded ),
		...
		'twitter'   => array(
			...
			'url'   => \esc_url( 'https://twitter.com/share?text=' . $message_encoded . '&url=' . $permalink ),
		...
		'instagram' => array(
			...
			'url'   => \esc_url( $attributes['instagram'] ),
		...
		'whatsapp'  => array(
			...
			'url'   => \esc_url( 'https://api.whatsapp.com/send?text=' . $message_encoded . $separator . $permalink ),
	...
	return \apply_filters( 'site_functionality/social_block/services', $services_data, $service, $attributes );
}
 ...
 */
function get_label( $service, $attributes ) {
	$services = services( $service, $attributes );
 ...
 * @return string Brand label.
 */
function get_url( $service, $attributes ) {
	$services = services( $service, $attributes );
	return $services['url'];
}
